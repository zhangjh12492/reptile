...
class Pyse(object):
    ...
    def __init__(self, browser='ff', paths=None):
        '''
        ...
        # options.add_argument('Authorization = "MAuth-91e9a66b683b3c117aed30180bb85176a8158556c1a174516dddedbbcaaeeb5fca24b098efe1dc4ef7857f860b322aff6acecf7b2098da424c2ac35db05dff25-MAuth"')
        # options.add_argument('Origin = "http://www.blr53889.com"')
        # options.add_argument('X-APP-ID = "20"')

        # firefox浏览器设置
        # fp = webdriver.FirefoxProfile(r'C:\Users\Administrator\AppData\Roaming\Mozilla\Firefox\Profiles\1ebffx99.default')
        ...
        if browser == "firefox" or browser == "ff":
            ...
            driver = webdriver.PhantomJS(executable_path=paths)
        elif browser == 'edge':
    ...
    def open_new_window(self, css):
        ...
        '''
        self.original_windows = self.driver.current_window_handle
        # el = self.get_element(css)
        el = css
        el.click()
        all_handles = self.driver.window_handles
        for handle in all_handles:
            if handle != self.original_windows:
...
#     driver = Pyse("chrome")
#     driver.open("http://cp.baochi888.com/")
